...
public class ErrorResponseTest {
    ...
    void testGetErrorsReturnsDefensiveCopy() {
        List<ErrorResponse.FieldError> errors = new ArrayList<>();
        errors.add(new ErrorResponse.FieldError("field1", "error message"));
        errorResponse.setErrors(errors);

        List<ErrorResponse.FieldError> retrieved = errorResponse.getErrors();
        retrieved.add(new ErrorResponse.FieldError("field2", "another error"));
    ...
    @Test
    void testSetErrorsStoresDefensiveCopy() {
        List<ErrorResponse.FieldError> errors = new ArrayList<>();
        errors.add(new ErrorResponse.FieldError("field1", "error message"));
        errorResponse.setErrors(errors);

        // Modify original list after setting
        errors.add(new ErrorResponse.FieldError("field2", "another error"));
    ...
    @Test
    void testGetErrorsReturnsCopyNotSameReference() {
        List<ErrorResponse.FieldError> errors = new ArrayList<>();
        errors.add(new ErrorResponse.FieldError("field1", "error"));
        errorResponse.setErrors(errors);
    ...
    @Test
    void testSetErrorsOverwritesPreviousErrors() {
        List<ErrorResponse.FieldError> firstErrors = new ArrayList<>();
        firstErrors.add(new ErrorResponse.FieldError("field1", "error1"));
        errorResponse.setErrors(firstErrors);

        List<ErrorResponse.FieldError> secondErrors = new ArrayList<>();
        secondErrors.add(new ErrorResponse.FieldError("field2", "error2"));
        secondErrors.add(new ErrorResponse.FieldError("field3", "error3"));
        errorResponse.setErrors(secondErrors);

        List<ErrorResponse.FieldError> retrieved = errorResponse.getErrors();
        assertEquals(2, retrieved.size());
        assertEquals("field2", retrieved.get(0).getField());
        assertEquals("field3", retrieved.get(1).getField());
    }
