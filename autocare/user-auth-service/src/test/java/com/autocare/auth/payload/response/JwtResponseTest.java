...
public class JwtResponseTest {
    ...
    public void testGetRolesReturnsDefensiveCopy() {
        ...
        // The internal list should not be affected
        List<String> secondReturnedRoles = response.getRoles();
        assertEquals(1, secondReturnedRoles.size());
        assertFalse(secondReturnedRoles.contains("ROLE_HACKER"));
    }
    ...
    @Test
    public void testGetRolesReturnsNullWhenConstructedWithNull() {
        JwtResponse response = new JwtResponse("token123", 1L, "testuser", "test@example.com", null);
        assertNull(response.getRoles());
    }
}