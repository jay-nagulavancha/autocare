...
public class SignupRequestTest {
    ...
    public void testSetAndGetPassword() {
        ...
        assertEquals("securePassword123", signupRequest.getPassword());
    }
    ...
    public void testGetRole_returnsDefensiveCopy() {
        ...
        assertFalse(roleAfterMutation.contains("ROLE_SUPERADMIN"),
                "Mutating the returned set should not affect internal state (EI_EXPOSE_REP fix)");
    }
    ...
    public void testSetRole_storesDefensiveCopy() {
        ...
        // Mutate the original set after setting - should not affect internal state
        roles.add("ROLE_ADMIN");
        Set<String> storedRoles = signupRequest.getRole();
        assertFalse(storedRoles.contains("ROLE_ADMIN"),
                "Mutating the original set after setRole should not affect internal state (EI_EXPOSE_REP2 fix)");
    }

    @Test
    public void testSetRole_withNull_returnsNull() {
        signupRequest.setRole(null);
        assertNull(signupRequest.getRole());
    }

    @Test
    public void testGetRole_returnsNull_whenNotSet() {
        assertNull(signupRequest.getRole());
    }
    ...
    @Test
    public void testGetRole_returnedSetIsIndependentCopy() {
        Set<String> roles = new HashSet<>();
        roles.add("ROLE_USER");
        signupRequest.setRole(roles);

        Set<String> firstGet = signupRequest.getRole();
        Set<String> secondGet = signupRequest.getRole();

        // Both should be equal but not the same instance
    ...
    @Test
    public void testSetRole_overwritesPreviousValue() {
    ...
    @Test
    public void testSetRole_withNullAfterNonNull() {
        Set<String> roles = new HashSet<>();
        roles.add("ROLE_USER");
        signupRequest.setRole(roles);
        assertNotNull(signupRequest.getRole());
