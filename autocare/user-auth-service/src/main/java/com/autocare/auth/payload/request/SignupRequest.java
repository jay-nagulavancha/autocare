...
public class SignupRequest {
    ...
    public Set<String> getRole() { return new java.util.Collections.UnmodifiableSet(this.role); }
    public void setRole(Set<String> role) { this.role = new java.util.HashSet<>(role); }
}